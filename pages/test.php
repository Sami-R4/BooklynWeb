...
<section class="step2">
    ...
    <form method="POST" action="../app/process.php" enctype="multipart/form-data">
        ...
        <div class="input-group">
            ...
            <input id="pen_name" name="pen_name" placeholder="Your Pen Name" type="text" required />
        </div>
        ...
        <div class="input-group file-upload">
            ...
            <input id="profile_pic" name="profile_pic" class="file-input" type="file" title="Upload Profile Picture (optional)" />
        </div>
